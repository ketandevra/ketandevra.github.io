    ...
    <>
      ...
      <nav className="hidden sm:flex items-center justify-between px-6 py-2 bg-white dark:bg-gray-800 shadow-sm">
        ...
        <div className="flex gap-6">
          <a href="/fund" className="text-sm text-gray-700 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white">कोष</a>
          <a href="/event" className="text-sm text-gray-700 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white">कार्यक्रम</a>
          <a href="/committee" className="text-sm text-gray-700 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white">कमिटी</a>
        </div>
      </nav>
