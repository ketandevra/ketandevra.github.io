    ...
    <main className="px-4 py-10 overflow-x-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Link href="/income" className="block">
          <section className="bg-white p-6 rounded-lg shadow-[0_3px_10px_rgb(0,0,0,0.2)] hover:shadow-[0_10px_20px_rgba(0,0,0,0.2)] transition-shadow duration-300 cursor-pointer">
